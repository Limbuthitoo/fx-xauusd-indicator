...
- Module 2 confirmation layer currently tracks 7 plugins: 15M/EMA alignment, VWAP, fresh FVG, order-block retest, engulfing candle, volume expansion, and entry confirmation candle. Volume expansion is record-only/research-first because XAUUSD provider volume may be incomplete.
