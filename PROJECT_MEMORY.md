...
- Module 2 confirmation profiles contain market-structure evidence only. The engine selects the strongest completed profile first, then applies trade geometry, RR, spread/news, score, and risk gates. A risk-blocked profile remains visible as prediction evidence but cannot become a BUY/SELL signal.
