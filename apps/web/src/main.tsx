...
function Module2QAControlPanel({
  ...
  const cases = [
    ...
    { code: "SWEEP_ONLY", label: "A: close-back", paper: true },
    { code: "SWEEP_BOS", label: "B: BOS", paper: true },
    { code: "SWEEP_MSS", label: "C: MSS", paper: true },
    { code: "SWEEP_ENGULFING", label: "D: engulfing", paper: true },
    { code: "BOS_RETEST", label: "E: BOS retest", paper: true },
    { code: "MSS_RETEST", label: "F: MSS retest", paper: true },
    { code: "EMA_ALIGNED_SWEEP", label: "G: EMA aligned", paper: true },
    { code: "SWEEP_VOLUME_EXPANSION", label: "H: volume", paper: true },
    { code: "MSS_DISPLACEMENT_RETEST", label: "I: MSS displacement retest", paper: true },
    { code: "SWEEP_NO_CONFIRMATION", label: "J: no confirmation" },
      ...
      <div className="setting-control">
        ...
        {setting.key === "feed.provider" ? (
          <div className="setting-fields">
            ...
            <label>Startup candles<input type="number" min="2016" max="5000" value={draft?.startupBackfillCount ?? 2016} onChange={(event) => setDraft({ ...draft, startupBackfillCount: Number(event.target.value) })} /></label>
