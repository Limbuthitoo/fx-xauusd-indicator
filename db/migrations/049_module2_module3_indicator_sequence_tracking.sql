...
UPDATE strategy_versions
SET configuration_json = jsonb_set(configuration_json, '{maximumBarsAfterPullbackTouch}', '6'::jsonb, true)
WHERE configuration_json->>'moduleCode' = 'strategy_lab_3';

UPDATE tenant_module_settings
SET value = jsonb_set(value, '{maximumBarsAfterPullbackTouch}', '6'::jsonb, true)
WHERE module_code = 'strategy_lab_3'
  AND key = 'vwapOpeningDrive.strategy';
